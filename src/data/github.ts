...
import type { GithubDataPayload } from '@/types/github'

export type { GithubCommentsData, GithubDataPayload, GithubRepoStats } from '@/types/github'
...
export const githubCommentsByPath = githubDataPayload.comments?.byPath ?? {}
